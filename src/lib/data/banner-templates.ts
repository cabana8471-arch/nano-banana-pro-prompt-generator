...
export const bannerTypeTemplates: BannerTemplate[] = [
  ...
  // Social Media / Content
  {
    ...
    promptFragment: "carousel ad banner, social media slideshow, swipeable content design",
  },
  {
    id: "banner-type-email-header",
    name: "Email Header",
    description: "Header for newsletters/email campaigns",
    promptFragment: "email header banner, newsletter top image, email marketing design",
  },
  {
    id: "banner-type-app-screenshot",
    name: "App Store Screenshot",
    description: "Promotional screenshot for app stores",
    promptFragment: "app store screenshot, mobile app preview, app listing promotional image",
  },
  {
    id: "banner-type-podcast-cover",
    name: "Podcast Cover",
    description: "Cover art for podcasts",
    promptFragment: "podcast cover art, audio show thumbnail, podcast episode banner",
  },
  {
    id: "banner-type-event-ticket",
    name: "Event Ticket",
    description: "Digital tickets for events",
    promptFragment: "event ticket design, digital admission pass, ticket stub aesthetic",
  },
  {
    id: "banner-type-menu-board",
    name: "Menu Board",
    description: "Digital signage for restaurants/cafes",
    promptFragment: "menu board design, digital signage, restaurant display banner",
  },
  {
    id: "banner-type-job-posting",
    name: "Job Posting",
    description: "Recruitment announcements",
    promptFragment: "job posting banner, recruitment announcement, hiring promotion design",
  },
  {
    id: "banner-type-countdown",
    name: "Countdown Banner",
    description: "With timer for launches",
    promptFragment: "countdown timer banner, launch countdown, time-sensitive announcement",
  },
  {
    id: "banner-type-video-thumbnail",
    name: "Video Thumbnail",
    description: "Thumbnail for YouTube/video",
    promptFragment: "video thumbnail design, YouTube preview image, clickable video cover",
  },
  {
    id: "banner-type-infographic",
    name: "Infographic",
    description: "Mini promotional infographics",
    promptFragment: "infographic banner, data visualization, informational graphic design",
  },
  {
    id: "banner-type-coupon",
    name: "Coupon/Voucher",
    description: "Digital discount coupons",
    promptFragment: "coupon design, discount voucher, promotional code banner",
  },
  {
...
export const industryTemplates: BannerTemplate[] = [
  ...
  // Services & Local Business
  {
    ...
    promptFragment: "coworking space style, shared office aesthetic, modern workspace design",
  },
  {
    id: "industry-dentistry",
    name: "Dentistry",
    description: "Dental clinics and oral health",
    promptFragment: "dental clinic style, dentistry aesthetic, oral health design",
  },
  {
    id: "industry-veterinary",
    name: "Veterinary",
    description: "Veterinary clinics and animal hospitals",
    promptFragment: "veterinary clinic style, animal hospital aesthetic, pet healthcare design",
  },
  {
    id: "industry-photography",
    name: "Photography",
    description: "Professional photography services",
    promptFragment: "photography studio style, photographer portfolio aesthetic, visual arts design",
  },
  {
    id: "industry-wedding",
    name: "Wedding Services",
    description: "Wedding and bridal services",
    promptFragment: "wedding services style, bridal aesthetic, matrimonial event design",
  },
  {
    id: "industry-moving",
    name: "Moving Services",
    description: "Moving and relocation services",
    promptFragment: "moving services style, relocation aesthetic, logistics design",
  },
  {
    id: "industry-cleaning",
    name: "Cleaning Services",
    description: "Professional cleaning services",
    promptFragment: "cleaning services style, housekeeping aesthetic, cleanliness design",
  },
  {
    id: "industry-daycare",
    name: "Daycare/Childcare",
    description: "Daycare centers and childcare services",
    promptFragment: "daycare style, childcare aesthetic, children's services design",
  },
  {
    id: "industry-tutoring",
    name: "Tutoring/Education",
    description: "Private tutoring and educational services",
    promptFragment: "tutoring style, private education aesthetic, learning services design",
  },
  {
    id: "industry-escape-room",
    name: "Escape Room",
    description: "Escape rooms and immersive entertainment",
    promptFragment: "escape room style, puzzle adventure aesthetic, immersive entertainment design",
  },
  {
    id: "industry-brewery",
    name: "Brewery/Winery",
    description: "Breweries, wineries, and craft beverages",
    promptFragment: "brewery style, craft beer aesthetic, winery artisan design",
  },
  {
    id: "industry-marketplace",
    name: "Marketplace",
    description: "Multi-vendor marketplace platforms",
    promptFragment: "marketplace style, multi-vendor aesthetic, e-commerce platform design",
  },
];
...
export const designStyleTemplates: BannerTemplate[] = [
  ...
  // New Design Styles
  {
    ...
    promptFragment: "neobrutalist design, bold raw aesthetic, hard edges stark colors",
  },
  {
    id: "design-vaporwave",
    name: "Vaporwave",
    description: "Retro 80s/90s, neon, grids, nostalgic",
    promptFragment: "vaporwave design, 80s 90s nostalgic aesthetic, neon grid retro",
  },
  {
    id: "design-bauhaus",
    name: "Bauhaus",
    description: "Geometric, primary colors, modernist",
    promptFragment: "bauhaus design, geometric modernist aesthetic, primary colors functional",
  },
  {
    id: "design-memphis",
    name: "Memphis Design",
    description: "Colorful, playful, geometric patterns",
    promptFragment: "memphis design, colorful playful aesthetic, geometric patterns 80s",
  },
  {
    id: "design-swiss",
    name: "Swiss/International",
    description: "Clean grid, strong typography",
    promptFragment: "swiss international design, clean grid aesthetic, strong typography",
  },
  {
    id: "design-japandi",
    name: "Japandi",
    description: "Japanese-Scandinavian minimalism",
    promptFragment: "japandi design, japanese scandinavian aesthetic, warm minimalist",
  },
  {
    id: "design-retrowave",
    name: "Retrowave/Synthwave",
    description: "80s synth aesthetic",
    promptFragment: "retrowave synthwave design, 80s synth aesthetic, neon sunset grid",
  },
  {
    id: "design-y2k",
    name: "Y2K Aesthetic",
    description: "Early 2000s digital style",
    promptFragment: "y2k design, early 2000s aesthetic, chrome bubble futuristic",
  },
  {
    id: "design-brutalist-web",
    name: "Brutalist Web",
    description: "Raw, unpolished, exposed structure",
    promptFragment: "brutalist web design, raw unpolished aesthetic, exposed structure",
  },
  {
    id: "design-skeuomorphic",
    name: "Skeuomorphic",
    description: "Realistic textures and shadows",
    promptFragment: "skeuomorphic design, realistic texture aesthetic, 3D shadows depth",
  },
  {
    id: "design-kawaii",
    name: "Kawaii",
    description: "Cute Japanese-inspired style",
    promptFragment: "kawaii design, cute japanese aesthetic, adorable pastel style",
  },
  {
    id: "design-dark-mode",
    name: "Dark Mode",
    description: "Dark UI optimized design",
    promptFragment: "dark mode design, dark UI aesthetic, low-light optimized",
  },
];
...
export const colorSchemeTemplates: BannerTemplate[] = [
  ...
  // Gradients & Mixed
  {
    ...
    promptFragment: "sunset gradient color scheme, orange pink purple palette, warm dusk tones",
  },
  {
    id: "color-berry-mix",
    name: "Berry Mix",
    description: "Violet, burgundy and rose tones",
    promptFragment: "berry mix color scheme, violet burgundy palette, rich berry tones",
  },
  {
    id: "color-fire-ice",
    name: "Fire & Ice",
    description: "Red to purple to blue contrast",
    promptFragment: "fire and ice color scheme, red purple blue palette, contrast temperature tones",
  },
  {
    id: "color-cotton-candy",
    name: "Cotton Candy",
    description: "Pastel pink and pastel blue",
    promptFragment: "cotton candy color scheme, pastel pink blue palette, sweet soft tones",
  },
  {
    id: "color-tropical",
    name: "Tropical",
  ...
  },
  {
    ...
    promptFragment: "mocha coffee color scheme, brown cream palette, warm cafe tones",
  },
  {
    id: "color-midnight",
    name: "Midnight Blue",
    description: "Deep navy to black gradient",
    promptFragment: "midnight blue color scheme, deep navy black palette, dark elegant tones",
  },
  {
    id: "color-peachy",
    name: "Peachy Keen",
    description: "Peach, coral and cream tones",
    promptFragment: "peachy keen color scheme, peach coral cream palette, soft warm tones",
  },
  {
    id: "color-sage-green",
    name: "Sage Green",
    description: "Muted green and off-white",
    promptFragment: "sage green color scheme, muted green palette, natural calm tones",
  },
  {
    id: "color-dusty-rose",
    name: "Dusty Rose",
    description: "Muted pink and mauve tones",
    promptFragment: "dusty rose color scheme, muted pink mauve palette, vintage feminine tones",
  },
  {
    id: "color-electric-lime",
    name: "Electric Lime",
    description: "Neon green and black contrast",
    promptFragment: "electric lime color scheme, neon green black palette, high energy tones",
  },
  {
    id: "color-bronze-copper",
    name: "Bronze & Copper",
    description: "Metallic warm tones",
    promptFragment: "bronze copper color scheme, metallic warm palette, industrial elegant tones",
  },
];
...
export const moodTemplates: BannerTemplate[] = [
  ...
  // New Moods
  {
    ...
    promptFragment: "nostalgic mood, warm familiar atmosphere, throwback sentimental feel",
  },
  {
    id: "mood-bold",
    name: "Bold & Daring",
    description: "Courageous, attention-grabbing",
    promptFragment: "bold daring mood, courageous atmosphere, attention-grabbing feel",
  },
  {
    id: "mood-mysterious",
    name: "Mysterious",
    description: "Intriguing, enigmatic",
    promptFragment: "mysterious mood, intriguing enigmatic atmosphere, curiosity-evoking feel",
  },
  {
    id: "mood-eco-conscious",
    name: "Eco-Conscious",
    description: "Green, sustainable, natural",
    promptFragment: "eco-conscious mood, sustainable atmosphere, environmentally aware feel",
  },
  {
    id: "mood-rebellious",
    name: "Rebellious",
    description: "Edgy, unconventional",
    promptFragment: "rebellious mood, edgy unconventional atmosphere, rule-breaking feel",
  },
  {
    id: "mood-whimsical",
    name: "Whimsical",
    description: "Fantasy, dreamlike",
    promptFragment: "whimsical mood, fantasy dreamlike atmosphere, magical feel",
  },
  {
    id: "mood-empowering",
    name: "Empowering",
    description: "Motivational, strength",
    promptFragment: "empowering mood, motivational strength atmosphere, confident feel",
  },
  {
    id: "mood-cozy",
    name: "Cozy & Warm",
    description: "Comfortable, homey",
    promptFragment: "cozy warm mood, comfortable homey atmosphere, inviting feel",
  },
  {
    id: "mood-fresh",
    name: "Fresh & Clean",
    description: "New, crisp, modern",
    promptFragment: "fresh clean mood, new crisp atmosphere, modern invigorating feel",
  },
  {
    id: "mood-adventurous",
    name: "Adventurous",
    description: "Exciting, exploration",
    promptFragment: "adventurous mood, exploration excitement atmosphere, discovery feel",
  },
];
...
export const seasonalTemplates: BannerTemplate[] = [
  ...
  // International Holidays
  {
    ...
    promptFragment: "Diwali theme, festival of lights aesthetic, Indian celebration design",
  },
  {
    id: "holiday-chinese-new-year",
    name: "Chinese New Year",
    description: "Lunar new year celebration",
    promptFragment: "Chinese New Year theme, lunar new year aesthetic, red gold celebration design",
  },
  {
    id: "holiday-ramadan",
    name: "Ramadan/Eid",
    description: "Islamic holidays",
    promptFragment: "Ramadan Eid theme, Islamic celebration aesthetic, crescent moon design",
  },
  {
    id: "holiday-hanukkah",
    name: "Hanukkah",
    description: "Jewish holiday",
    promptFragment: "Hanukkah theme, Jewish celebration aesthetic, menorah blue design",
  },
  // Additional Sales Events
  {
    ...
    promptFragment: "winter sale theme, cold season deals aesthetic, snowy shopping design",
  },
  {
    id: "special-mid-year-sale",
    name: "Mid-Year Sale",
    description: "Half-year deals",
    promptFragment: "mid-year sale theme, half-year deals aesthetic, summer clearance design",
  },
  {
    id: "special-anniversary-sale",
    name: "Anniversary Sale",
    description: "Store/brand anniversary",
    promptFragment: "anniversary sale theme, celebration deals aesthetic, milestone shopping design",
  },
  {
    id: "special-grand-opening",
    name: "Grand Opening",
    description: "New launch celebration",
    promptFragment: "grand opening theme, new launch aesthetic, ribbon-cutting celebration design",
  },
  {
    id: "special-pre-order",
    name: "Pre-Order",
    description: "Pre-order promotions",
    promptFragment: "pre-order theme, early access aesthetic, reservation promotion design",
  },
  {
    id: "special-vip-exclusive",
    name: "VIP Exclusive",
    description: "VIP exclusive offers",
    promptFragment: "VIP exclusive theme, members-only aesthetic, premium access design",
  },
  {
    id: "event-prime-day",
    name: "Prime Day Style",
    description: "Major shopping event style",
    promptFragment: "prime day theme, mega deals aesthetic, major shopping event design",
  },
  {
    id: "special-weekend-deal",
    name: "Weekend Deal",
    description: "Weekend specials",
    promptFragment: "weekend deal theme, Saturday Sunday specials aesthetic, limited time design",
  },
];
...
export const backgroundStyleTemplates: BannerTemplate[] = [
  ...
  // NEW: Additional background styles
  {
    ...
    promptFragment: "topographic background, contour line pattern, map elevation backdrop",
  },
  {
    id: "bg-isometric-grid",
    name: "Isometric Grid",
    description: "3D isometric grid",
    promptFragment: "isometric grid background, 3D angled pattern, dimensional grid backdrop",
  },
  {
    id: "bg-halftone",
    name: "Halftone",
    description: "Comic print dot pattern",
    promptFragment: "halftone background, dot pattern print, comic book backdrop",
  },
  {
    id: "bg-watercolor",
    name: "Watercolor",
    description: "Watercolor texture",
    promptFragment: "watercolor background, painted wash texture, artistic fluid backdrop",
  },
  {
    id: "bg-terrazzo",
    name: "Terrazzo",
    description: "Modern terrazzo pattern",
    promptFragment: "terrazzo background, speckled stone pattern, modern composite backdrop",
  },
  {
    id: "bg-brush-strokes",
    name: "Brush Strokes",
    description: "Brush stroke texture",
    promptFragment: "brush strokes background, painted texture, artistic stroke backdrop",
  },
  {
    id: "bg-pixel-art",
    name: "Pixel Art",
    description: "Retro pixel background",
    promptFragment: "pixel art background, 8-bit retro pattern, blocky nostalgic backdrop",
  },
  {
    id: "bg-circuit-board",
    name: "Circuit Board",
    description: "Electronic circuit pattern",
    promptFragment: "circuit board background, electronic pattern, tech PCB backdrop",
  },
  {
    id: "bg-neon-lights",
    name: "Neon City Lights",
    description: "Urban neon lights",
    promptFragment: "neon lights background, city glow pattern, urban nightlife backdrop",
  },
  {
    id: "bg-liquid-metal",
    name: "Liquid Metal",
    description: "Chrome/liquid metal",
    promptFragment: "liquid metal background, chrome fluid pattern, metallic flowing backdrop",
  },
  {
    id: "bg-smoke-fog",
    name: "Smoke/Fog",
    description: "Smoke or fog effect",
    promptFragment: "smoke fog background, misty atmosphere, ethereal haze backdrop",
  },
  {
    id: "bg-aurora",
    name: "Aurora Borealis",
    description: "Aurora style gradient",
    promptFragment: "aurora borealis background, northern lights pattern, cosmic glow backdrop",
  },
];
...
export const visualEffectsTemplates: BannerTemplate[] = [
  ...
  // Advanced Effects (NEW)
  {
    ...
    promptFragment: "chromatic aberration effect, RGB color split, prismatic distortion",
  },
  {
    id: "effect-double-exposure",
    name: "Double Exposure",
    description: "Overlapping images blend",
    promptFragment: "double exposure effect, overlapping images, blended photography",
  },
  {
    id: "effect-reflection",
    name: "Mirror Reflection",
    description: "Mirrored surface effect",
    promptFragment: "mirror reflection effect, symmetrical mirroring, reflected surface",
  },
  {
    id: "effect-scanlines",
    name: "Scanlines",
    description: "Retro CRT monitor lines",
    promptFragment: "scanlines effect, CRT monitor lines, retro screen texture",
  },
  {
    id: "effect-halftone-dots",
    name: "Halftone Dots",
    description: "Print screen dot pattern",
    promptFragment: "halftone dots effect, print screen pattern, comic dot texture",
  },
  {
    id: "effect-frosted-glass",
    name: "Frosted Glass",
    description: "Matte blur surface",
    promptFragment: "frosted glass effect, matte blur surface, translucent panel",
  },
  {
    id: "effect-smoke",
    name: "Smoke Effect",
    description: "Artistic smoke trails",
    promptFragment: "smoke effect, wispy fog trails, atmospheric mist",
  },
  {
    id: "effect-liquid",
    name: "Liquid Effect",
    description: "Fluid morphing shapes",
    promptFragment: "liquid effect, fluid morphing shapes, flowing dynamic form",
  },
  {
    id: "effect-prism",
    name: "Prism/Rainbow",
    description: "Light spectrum refraction",
    promptFragment: "prism effect, rainbow refraction, light spectrum dispersion",
  },
  {
    id: "effect-emboss",
    name: "Embossed",
    description: "Raised relief texture",
    promptFragment: "embossed effect, raised relief texture, 3D pressed surface",
  },
  {
    id: "effect-pixelate",
    name: "Pixelate",
    description: "Artistic blocky mosaic",
    promptFragment: "pixelate effect, blocky mosaic, low resolution artistic",
  },
  {
